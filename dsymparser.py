...
class FunctionDefinition:
    ...
    def add_to_args_name(self, arg_name):
        ...
        """
        if arg_name == "_cmd":
            self.can_add_param = True
            return

        if not (arg_name == "_cmd" or arg_name == "self") and self.can_add_param:
...
class DSYMParser:
    ...
    def create_function(self):
        ...
        if self.function_def.is_function_valid:
            print self.function_def.get_function_string()
...
dsymParser.parse_dsym_file("/Users/prabodhprakash/Documents/Hansel/script/HanselInfoDir/crumb.dSYM")